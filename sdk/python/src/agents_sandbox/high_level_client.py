...
from .client import SandboxClient as RawSandboxClient
...
class AgentsSandboxClient:
    ...
    def __init__(
        ...
        *,
        ...
        self._rpc_client = RawSandboxClient(self.socket_path, timeout_seconds=timeout_seconds)
    ...
    async def subscribe_sandbox_events(
        ...
        *,
        ...
        stream_client = RawSandboxClient(
            self.socket_path,
            timeout_seconds=(
