...
- **Event retention is bounded by TTL.** Deleted sandbox event streams remain queryable until the configured retention TTL expires. See [Sandbox Container Lifecycle](sandbox_container_lifecycle.md).
